<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        if($true) {
            ...
            $sql = "INSERT INTO `post`(`username`, `Date`, `content`,`userid`, `pfp`) VALUES ('$username','$date','$newcontent','$userid','$pfp')";
            $db->query($sql);
        }
    }
?>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input class="form-control text-center bg-light" type="text" name="content" id="" placeholder="Írj ide valamit">
